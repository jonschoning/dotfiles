...
let s:bwc.tardis = ['ff0099', 39]
" let s:bwc.tardis = ['FFFFFF', 39]
...
call s:HL('StatusLine',   'coal', 'snow',     'bold')
...
" Punctuation
call s:HL('htmlTag',    'taffy2', 'bg', 'none')
call s:HL('htmlEndTag', 'taffy2', 'bg', 'none')

" Tag names
call s:HL('htmlTagName', 'taffy', '', 'none')
call s:HL('htmlSpecialTagName', 'taffy', '', 'bold')
call s:HL('htmlSpecialChar', 'lime', '', 'none')

" Attributes
call s:HL('htmlArg', 'orange', '', 'none')
call s:HL('htmlString', 'dirtyblonde', '', 'none')
...
call s:HL('xmlTag', 'taffy2', 'bg', 'none')
call s:HL('xmlEndTag', 'taffy2', 'bg', 'none')
call s:HL('xmlTagName', 'taffy', 'bg', 'none')
call s:HL('xmlAttrib', 'orange', '', 'none')
call s:HL('xmlString', 'dirtyblonde', '', 'none')
